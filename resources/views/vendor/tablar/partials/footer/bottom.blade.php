            ...
            <div class="col-lg-auto ms-lg-auto">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        {{-- <a href="https://github.com/takielias/tablar" target="_blank" class="link-secondary" rel="noopener">Source code</a> --}}
                    </li>
                    <li class="list-inline-item">
            ...
            <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        ...
                        <a href="https://ebuz.xyz" class="link-secondary">{{config('tablar.bottom_title',
                            'TabLar')}}</a>.
                        All rights reserved
                    </li>
                    <li class="list-inline-item">
