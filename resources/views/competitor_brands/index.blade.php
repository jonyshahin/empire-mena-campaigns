            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Competitor Brands</h3>
                    </div>
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="invoice.html" class="text-reset" tabindex="-1">{{$brand->name}}</a>
                                    </td>
                                    <td><span class="text-muted">{{$brand->description}}</span></td>
                                    <td class="text-end">
                                        <span class="dropdown">
