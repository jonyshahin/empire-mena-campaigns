                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="text-muted">{{$consumer->id}}</span></td>
                                    <td><a href="invoice.html" class="text-reset" tabindex="-1">{{$consumer->name}}</a>
                                    </td>
                                    <td><span class="text-muted">{{$consumer->description}}</span></td>
                                    <td class="text-end">
                                        <span class="dropdown">
